...
<body>
    ...
    <div class="container">
        ...
        <label><input type="text" name="name" placeholder="Your username"/></label>
        <label><input type="password" name="pwd" placeholder="password"></label>
        <label><input type="password" name="refill" placeholder="please confirm your password"></label>
 
            <input type="submit" value="Sign up"/>
            <p class="change_link" style="text-align: center">
                <span class="text">Already a member ?</span>
                <a href="login.jsp" class="to_login"> Go and log in </a>
            </p>
        </form>
    </div>
    <ul>
